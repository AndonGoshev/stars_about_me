...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for sign in ZodiacSigns.values:
            weekly_aspects_data = daily_aspects()
            ...
            zodiac_entry.content = daily_horoscope(sign, weekly_aspects_data)
        ...
        self.stdout.write(self.style.SUCCESS(f'Fetching completed. Full response for weekly horoscopes time: {round(horoscope_full_response_time, 3)} seconds.'))
