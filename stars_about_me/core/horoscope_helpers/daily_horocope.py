...
def daily_horoscope(sign, aspects):
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                Write a daily horoscope in bulgarian grammatically correct , in "The pattern" astrology app vibe!
                
                **Think of how the planetary aspects will personally influence the person for the given sign. And your answer should be different for any a different sign based on the planets.**
                
                Pick randomly some of the aspects, make sure you pick randomly!!!
